const LoadingElement = props => (
	<div className="current-weather-container">
		...
		<p className="weather-description">
			{props.lang === 'sl' ? (
				<small>
					Vreme v <strong>Kranjski Gori</strong> je trenutno{' '}
					<strong>_____________</strong>.
				</small>
			) : (
				<small>
					<strong>_____________</strong> at the moment in{' '}
		...
		<div className="extra-data-container">
			<div className="extra-data humidity">
				<img
					...
					alt="vlaznost"
				/>
				<small>{props.lang === 'sl' ? 'Vlažnost' : 'Humidity'}</small>
				<span>--%</span>
			</div>
			<hr />
			<div className="extra-data wind-speed">
				<img
					...
					alt="veter"
				/>
				<small>{props.lang === 'sl' ? 'Veter' : 'Wind speed'}</small>
				<span>
					-.- <small>m/s</small>
				</span>
			</div>
			...
			<div className="extra-data clouds">
				<img
					...
					alt="oblacnost"
				/>
				<small>{props.lang === 'sl' ? 'Oblačnost' : 'Clouds'}</small>
				<span>--%</span>
			</div>
		</div>
	</div>
