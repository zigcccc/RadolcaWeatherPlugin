    ...
    return(
      <div className="current-weather-container">
        ...
        <p className="weather-description">
          {
            this.props.lang === 'sl'
            ? <small>Vreme v <strong>Kranjski Gori</strong> je trenutno <strong>{this.props.desc}</strong>.</small>
            : <small><strong>{this.capitalizeFirstLetter(this.props.desc)}</strong> at the moment in <strong>Kranjska Gora</strong>.</small>
          }
        </p>
        ...
        <div className="extra-data-container">
          <div className="extra-data humidity">
            ...
            </small><span>{this.props.extra.humidity}%</span>
            </div>
          <hr/>
          <div className="extra-data wind-speed">
            ...
            </small><span>{this.props.extra.windSpeed} <small>m/s</small></span>
          </div>
          <hr/>
          <div className="extra-data clouds">
            ...
            </small><span>{this.props.extra.clouds}%</span>
          </div>
        </div>
      </div>
    )
